 ...
 */
    ...
    if ("a" !== "a"){
        if ("b" === "b"){
            console.log("b === b is true");
        }else{
            console.log("b === b is not true");
        };
 ...
 */
    ...
    if ((1 === 1) && ("hi" === "hi")){
        console.log("both sides are true");
    };
 ...
 ********************************************/
    ...
    var weatherFn = function(weather, waves){
        if (weather === "sunny"){
            if(waves === 10){
                bobsMood = "pumped";
    ...
    var mood = weatherFn(value1, value2)
    console.log(mood);
